...
class ApiGui(wx.Dialog):
    def __init__(self, config: ConfigParser):
        ...
        title_text: wx.StaticText = wx.StaticText(
            my_panel, id=wx.ID_ANY, label="Get InSite API data"
        )
        ...
        self.project_text: wx.TextCtrl = wx.TextCtrl(
            my_panel, id=wx.ID_ANY, value=self.project
        )
        grid.Add(
            self.project_text, pos=(1, 1), flag=wx.EXPAND | wx.ALIGN_LEFT, border=5
        )
        ...
        self.pmi_account_text: wx.TextCtrl = wx.TextCtrl(
            my_panel, id=wx.ID_ANY, value=self.pmi_account
        )
        grid.Add(self.pmi_account_text, pos=(2, 1), flag=wx.EXPAND | wx.ALL, border=5)

        aou_account_label: wx.StaticText = wx.StaticText(
            my_panel, id=wx.ID_ANY, label="AoU Service Account"
        )
        grid.Add(aou_account_label, pos=(3, 0), flag=wx.ALIGN_RIGHT, border=5)
        self.aou_account_text: wx.TextCtrl = wx.TextCtrl(
            my_panel, id=wx.ID_ANY, value=self.aou_service_account
        )
        ...
        self.token_file_text: wx.TextCtrl = wx.TextCtrl(
            my_panel, id=wx.ID_ANY, value=self.token_file
        )
        grid.Add(self.token_file_text, pos=(4, 1), flag=wx.EXPAND | wx.ALL, border=5)

        self.status_text: wx.StaticText = wx.StaticText(
            my_panel, id=wx.ID_ANY, label="Ready"
        )
        grid.Add(
            self.status_text, pos=(5, 0), span=(1, 2), flag=wx.EXPAND | wx.ALL, border=5
        )

        ok_button: wx.Button = wx.Button(
